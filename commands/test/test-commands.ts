import {EditorState, EditorSelection, StateCommand, Extension} from "@observablehq/codemirror-next/state"
import {indentMore, indentLess, indentSelection, insertNewlineAndIndent, deleteTrailingWhitespace} from "@observablehq/codemirror-next/commands"
